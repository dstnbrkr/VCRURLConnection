...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of VCRURLConnection
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Dustin Barker" => "dustin.barker@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Dustin Barker', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "http://EXAMPLE/VCRURLConnection.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/VCRURLConnection/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/VCRURLConnection', :revision => '1.0.0' }
